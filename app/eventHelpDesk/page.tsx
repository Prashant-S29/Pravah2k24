...
const formField = [
  {
    fieldName: "eventIssue",
    fieldPlaceholder: "Describe your quires",
  },
];

const EVENT_HELP_DESK = () => {
        ...
        <div className="w-full">
          ...
          <div className="flex justify-center mt-[20px]">
            <div className="p-[15px] border border-black rounded-[15px] text-center w-[300px] bg-white">
              <div>
                <span className="font-bold">Kanishk Bhardwaj</span>
              </div>
              <div className="leading-tight">
                <span className="text-[15px] ">8949294354</span>
              </div>
              <div className="leading-tight">
                <span className="text-[14px] ">Event Committee Head</span>
              </div>
              <div className="w-full flex justify-center gap-[30px] mt-[10px]  -mb-[35px]">
                <div className="p-[8px] rounded-full w-fit flex justify-center bg-black ">
                  <Link href="https://wa.me/8949294354" target="_blank">
                    <Image
                      src={whatsapp}
                      alt="whatsapp"
                ...
                <div className="p-[7px] rounded-full w-fit flex justify-center bg-black ">
                  <Link
                    href="https://www.linkedin.com/in/kanishk-bhardwaj-02700223b"
                    target="_blank"
                  >
                    <Image
                      src={linkedin}
...
export default EVENT_HELP_DESK;
