  ...
  return (
    <>
      <div className="w-full min-h-screen text-center">
        ...
        <div>
          <span className="text-[32px] sm:text-[48px] font-black">UMANG</span>
        </div>
        <div className="mt-5 px-[20px] sm:px-[10%] lg:px-[15%]">
          <span className="text-[14px] sm:text-[16px] font-semibold">
            The main aim of {'"'}Umang{'"'} is to provide a warm and welcoming
            atmosphere for residents of old age homes. It{"'"}s about making
            older people feel happy, included, and less lonely by offering
            enjoyable activities, social interactions, and entertainment.
          </span>
        </div>
        ...
        <div className="flex flex-wrap  justify-center w-full text-center mt-[40px] gap-y-[30px]">
          {socialEventsCoordinator.map((coordinatorDetail, index) => (
            <div key={index}>
              {coordinatorDetail.eventName === "Umang" && (
                <>
                  <div>
