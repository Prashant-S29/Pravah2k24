...
const phoneNumberLink = 'tel:+1234567890';
const linkedInLink = 'https://www.linkedin.com/in/example';
        ...
        <>
            ...
            <div className="card card-pink h-100 overflow-hidden shadow bg-white border-0 px-0">
                <div className="card-shape">
                    <img src={data.img} className="card-img-top" alt="Jane" />
                ...
                <div className="card-footer d-flex justify-content-between align-items-center">
                    <div>
                        <p className="mb-0 font-weight-bolder" style={{ color: "#ff2c95" }}>
                            {data.name}
                        </p>
                        <small className="text-muted">{data.speciality}</small>
                    </div>
                    <div className="d-flex ">
                        ...
                        {/* You can replace the "#" with the actual link */}
